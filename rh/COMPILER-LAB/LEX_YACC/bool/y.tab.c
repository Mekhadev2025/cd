...
/*#define YY_USE_CLASS 
*/
/*  A Bison++ parser, made from bool.y  */
...
const int YY_parse_CLASS::TRUE=258;
const int YY_parse_CLASS::FALSE=259;
const int YY_parse_CLASS::AND=260;
const int YY_parse_CLASS::OR=261;
const int YY_parse_CLASS::NOT=262;
...
static const char * const yytname[] = {   "$","error","$illegal.","TRUE","FALSE",
...
-32768,-32768,     6,     6,     2,-32768,    10,     6,     6,-32768,
-32768,-32768,     3,-32768
};
